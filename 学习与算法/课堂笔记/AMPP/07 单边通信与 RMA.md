...
> [!info] 知识图谱
> 前置：[[T 6|T6 邻域集体通信]] · 后续：[[T8|T8 MPI 共享内存]] · 原始导出稿：[[T7|T7 原始稿]] · 手写批注：[[T7 - Ink.svg]]
...
- 前置：[[T 6|T6 邻域集体通信]]——同样是「让通信模式更贴近实际拓扑」这条主线上的一站
- 后续：[[T8|T8 MPI 共享内存]]——同一节点内进程共享内存，与 RMA 是两条不同的「绕开消息传递」路径
